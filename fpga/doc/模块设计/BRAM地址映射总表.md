...
当前功率谱数据已经冻结为 32 位，可直接匹配常用的 32 位 AXI BRAM
Controller 数据端口。在以下事项确定之前，仍不定义 PS 绝对地址：

1. 频谱 BRAM 是否直接开放给 PS；
2. HMI 最终绘图需要 800 点、1024 点还是完整 2048 点；
3. 是否另设一个专供 PS/HMI 使用的压缩频谱显示 BRAM；
4. 最终 Block Memory Generator 的深度和端口配置。
