...
frame_done_event ── event_cdc_handshake ──> frame_ready_event

30 MHz ADC 写域                              100 MHz FIFO/FIR 域
frame_consumed    <─ event_cdc_handshake ── fifo_frame_done
```
...
```systemverilog
event_cdc_handshake u_frame_ready_cdc (
    .src_clk            (clk_30m),
    .src_rst            (rst_30m),
...
```systemverilog
event_cdc_handshake u_frame_consumed_cdc (
    .src_clk            (clk_100m),
    .src_rst            (rst_100m),
